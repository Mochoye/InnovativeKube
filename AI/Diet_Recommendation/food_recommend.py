...
Original file is located at
    https://colab.research.google.com/drive/190FaSdaDqrgnXvOgfUe3bkAE-iN5J5ih
"""
...
user_inputs = CaloricIntakeEstimator.get_user_inputs()
result = caloric_estimator.calculate_daily_calories_direct(user_inputs)
print(f"Estimated Daily Caloric Intake for Weight Change: {result[0]:.2f} calories")

class MealPlanner:
    def __init__(self):
        self.food_df = None
        self.clustering_data_standardized = None
        self.columns_for_clustering = None
